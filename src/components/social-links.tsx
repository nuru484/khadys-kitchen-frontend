...
/**
 * Round social-icon buttons. `tone` matches the surface: "light" for cream
 * pages (contact), "dark" for the ink footer.
 */
export function SocialLinks({
  ...
  tone?: "light" | "dark";
  /** md = the contact page's 50px circles; sm = compact (footer). */
  size?: "sm" | "md";
  className?: string;
}) {
  return (
